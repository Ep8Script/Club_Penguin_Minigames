...
function Lobby() {
	...
	var lobbyLoad = setInterval(function() {
		...
		if(p == 100) {
			...
			app.setState("Lobby")
			$(".loading").addClass("in-game").removeClass("loading").empty()
			$("body").append('<div class="game"><div class="victory-screen"><span class="header">Leaderboard</span><span class="placement first">1st <span class="player-name"><span class="name"></span> — <img class="timer" src="Assets/Timer.png"><span class="time"></span></span></span><span class="placement second">2nd <span class="player-name"><span class="name"></span> — <img class="timer" src="Assets/Timer.png"><span class="time"></span></span></span><span class="placement third">3rd <span class="player-name"><span class="name"></span> — <img class="timer" src="Assets/Timer.png"><span class="time"></span></span></span><span class="placement fourth">4th <span class="player-name"><span class="name"></span> — <img class="timer" src="Assets/Timer.png"><span class="time"></span></span></span><div class="play-again">Play Again</div></div><img class="background" src="Assets/Sky.png"><img class="clouds" src="Assets/Clouds.png" style="left:255px"><img class="corner" src="Assets/MapCorner.png"><div class="map"><div class="map-bar"></div></div><div class="tiles"><img class="tile tile-start" src="Assets/HillTiles/Start.png"><img class="tile tile-0" src="Assets/HillTiles/0.png" style="left:485px;top:318px"><img class="tile tile-0" src="Assets/HillTiles/0.png" style="left:734px;top:467px"></div><div class="waiting"><div>Waiting for Client...</div><img src="Assets/Loading.gif"></div><div class="server-status">Server Status: <span class="o'+(multiplayer?"n":"ff")+'line"></span></div></div><iframe src="Assets/Silence.mp3" allow="autoplay" id="audio" style="display:none"></iframe>')
...
function StartGame() {
	...
	setTimeout(function() {
		...
		// Start the music
		$("#audio").after('<audio autoplay loop src="Assets/Music.mp3">')
		setTimeout(function() {
			$(".countdown").remove()
...
// Check if visiting on a mobile device
function testMobile() {
	var check = false;
