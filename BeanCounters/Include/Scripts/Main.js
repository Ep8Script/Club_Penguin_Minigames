// Import other files
require("Include/Scripts/Hazard", true)
require("Include/Scripts/Input", true)
require("Include/Scripts/Play", true)
require("Include/Scripts/VR", true)
...
app.onLoad(function() {
	...
	preload([a+"Background.png",a+"Button.png",a+"Game.png",a+"Main.png",a+"Platform.png",a+"Start.png",a+"Truck.png",h+"Anvil.png",h+"Anvil_Broken.png",h+"Bag_1.png",h+"Bag_2.png",h+"Bag_3.png",h+"Bag_Broken.png",h+"Fish.png",h+"Fish_Broken.png",h+"Life.png",h+"Vase.png",h+"Vase_Broken.png",p+"0.png",p+"1.png",p+"2.png",p+"3.png",p+"4.png",p+"5.png",p+"Anvil_Dead.png",p+"Bag_Dead.png",p+"Fish_Dead.png",p+"Vase_Dead.png",v+"LaboVR.png"], function() {
...
function MainMenu() {
	app.setState("Menu")
	$("body").addClass("in-game").removeClass("loading").html('<div class="menu"><img class="game-menu" src="Assets/Main.png"><div class="start-button"><img class="start" src="Assets/Start.png"><span>Play</span><img class="button" src="Assets/Button.png"></div><div class="vr-start"><span>VR Mode</span><img class="button" src="Assets/Button.png"></div><img class="logo" src="Assets/Game.png"></div>')
